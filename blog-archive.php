...
<head>
    ...
    <meta property="og:image" content="assets/img/blog/blog-cfl.jpg" />
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <article class="mu-blog-single-item">
                                            <figure class="mu-blog-single-img">
                                                <a href="#"><img src="assets/img/blog/blog-cfl.jpg" alt="img"></a>
                                                <figcaption class="mu-blog-caption">
                                                    <h3><a href="cfl.php">How CFL are made?</a></h3>
                                                </figcaption>
                                            </figure>
...
<!--                                                <span><i class="fa fa-comments-o"></i>87</span>-->
                                            ...
                                            <div class="mu-blog-description">
                                                <p>CFL are energy saving lamps that have almost replaced convection halogen bulbs from daily use.
                                                Find out how they are manufactured</p>
                                                <a class="mu-read-more-btn" href="cfl.php">Read More</a>
                                            </div>
                                        </article>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <article class="mu-blog-single-item">
                                            <figure class="mu-blog-single-img">
                                                <a href="#"><img src="assets/img/blog/schools.jpg" alt="img"></a>
                                                <figcaption class="mu-blog-caption">
                                                    <h3><a href="robotics_in_schools.php">Why robotics should be taught right from the school</a></h3>
                                                </figcaption>
                                            </figure>
                                            <div class="mu-blog-meta">
...
<!--                                                <span><i class="fa fa-comments-o"></i>87</span>-->
                                            ...
                                            <div class="mu-blog-description">
                                                ...
                                                <a class="mu-read-more-btn" href="robotics_in_schools.php">Read More</a>
                                            </div>
                                        </article>
                                    </div>
<!--                                    <div class="col-md-6 col-sm-6">-->
...
<!--                                    </div>-->
                                    <div class="col-md-6 col-sm-6">
                                        <article class="mu-blog-single-item">
                                            <figure class="mu-blog-single-img">
                                                <a href="#"><img src="assets/img/blog/blog-top10.jpg" alt="img"></a>
                                                <figcaption class="mu-blog-caption">
                                                    <h3><a href="top10science.php">Top 5 discoveries of all time</a></h3>
                                                </figcaption>
                                            </figure>
                                            <div class="mu-blog-meta">
                                                <a href="#">By Admin</a>
...
<!--                                                <span><i class="fa fa-comments-o"></i>87</span>-->
                                            ...
                                            <div class="mu-blog-description">
                                                <p>20th and 21st century has seen a scientific revolution all around the globle. This time has seen great scientists who went
                                                    a step further and discovered something great for which the society is still great full to them.</p>
                                                <a class="mu-read-more-btn" href="top10science.php">Read More</a>
                                            </div>
                                        </article>
                                    </div>
<!--                                </div>-->
