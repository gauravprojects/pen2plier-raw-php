...
<!-- Start message box -->
    <div class="container">
        <div class="row">
               ...
               // echo $author.$email.$subject.$comment;

                $sql= "INSERT INTO contact_us(author,email,subject,comment)
                        VALUES ('$author','$email','$subject','$comment') ";

                if ($conn->query($sql) === TRUE) {
                    echo "Thank you ";
                    echo '<span style="color: #01bafd">'.$author.'</span>   for reaching us!';
                    echo "<br>";
                    echo "You are very important to us and aur co-ordinators will reach you as soon as possible.";
                } else {
        ...
        <div class="mu-footer-bottom">
            <div class="container">
                <div class="mu-footer-bottom-area">
                    <p>&copy; All Right Reserved. Designed by <a href="http://www.pen2plier.com/" rel="nofollow">Pen2Plier</a></p>
                </div>
            </div>
        </div>
        <!-- end footer bottom -->
