...
<head>
    ...
    <title>Pen2Plier | How CFL are made</title>
                                    ...
                                    <div class="col-md-12">
                                        <article class="mu-blog-single-item">
                                            <figure class="mu-blog-single-img">
                                                <a href="#"><img alt="img" src="assets/img/blog/blog-cfl.jpg" height="400px" width="300px"></a>
                                                <figcaption class="mu-blog-caption">
                                                    <h3><a href="#">How CFL are made?</a></h3>
                                                </figcaption>
                                            </figure>
...
<!--                                                <span><i class="fa fa-comments-o"></i>87</span>-->
                                            ...
                                            <div class="mu-blog-description">
                                                <p>A compact fluorescent lamp (CFL), also called compact fluorescent light is  energy-saving light source, and compact fluorescent tube, is a fluorescent lamp designed to replace an incandescent lamp</p>

                                                <p> Advantages of using CFL bulbs over convectional buls are:-</p>
                                                <ul>
                                                    <li>For same amount of light they only consume one third or one fifth energy.</li>
                                                    <li>They last 7-8 times longer than normal bulbs.</li>
                                                    <li>Can save upto five times electricity bill in their life time.</li>
                                                    <li>You can do your part in reducing carbon emissions by changing over to CFLs. </li>
                                                    <li>CFLs are highly versatile and can be used in any setting that you would normally use incandescent bulbs.</li>
                                                </ul>

                                                <br>

                                                <p>Compact fluorescent bulbs (CFLs) are made using the same basic technology as the traditional fluorescent bulb, which has been in use for nearly a century. They are made from two main parts, which include a simple glass tube and a electric ballast. The inside of the tube is coated with phosphorus. Electricity passes through the ballast and produces ultraviolet (UV) light. This UV light interacts with the phosphorus coating on the bulb, causing it to glow bright white, producing light that is emitted from the bulb. </p>
                                                <h2>Why spiral shape?</h2>
                                                <p>Many people associate CFLs with their unique spiral shape. This spiral pattern is made using machines specifically designed to
                                                    spin glass. Once the bulb is cool, the air is vacuumed out, and small amounts of mercury gas are added.
                                                    The spiral shape of these bulbs was built out of necessity. Because fluorescent bulbs produce light only from their
                                                    phosphorus coating, there needs to be a certain amount of surface area available for this coating.
                                                    The spiraling glass tube provides the maximum amount of surface space in the smallest total area, which allows
                                                    the bulb to produce sufficient lighting for most applications.
                                                    Early attempts at using a standard round bulb produced dim and off-color lighting that did not appeal to consumers.</p>

                                                <p> Here is video which shows how CFL tubes are manufactured in industry.</p>

                                                <br>
                                                <iframe width="600" height="380"
                                                        src="https://www.youtube.com/embed/QXc1c31WB_k">
                                                </iframe>
