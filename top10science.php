...
<head>
    ...
    <title>Pen2Plier | Top 5 scientific discoveries of all times</title>
                                    ...
                                    <div class="col-md-12">
                                        <article class="mu-blog-single-item">
                                            <figure class="mu-blog-single-img">
                                                <a href="#"><img alt="img" src="assets/img/blog/blog-top10.jpg" height="400px" width="300px"></a>
                                                <figcaption class="mu-blog-caption">
                                                    <h3><a href="#">Top 5 scientific discoveries of all time.</a></h3>
                                                </figcaption>
                                            </figure>
                                            <div class="mu-blog-meta">
                                                <a href="#">By Admin</a>
                                                <a href="#">15 July 2016</a>
                                                <!--                                                <span><i class="fa fa-comments-o"></i>87</span>-->
                                            </div>
                                            <div class="mu-blog-description">
                                                <p>20th and 21st century has seen a scientific revolution all around the globle. This time has seen great
                                                scientists like Sir Issac Newton , Thomos Edision , Albert Einstien and many others who went a step further
                                                and discovered something great for which the society is still great full to them.</p>

                                                <p> According to us top 5 scientific discoveries of all time are:-</p>

                                                <div>
                                                    <h3>1- The wheel<h3>
                                                            <h6>Discovered in 4th millenum BCE</h6>
                                                            <p>With discovery of wheel and their use in animal carts, transportation from one place
                                                                to another became very easy.</p>

                                                            <img alt="img" src="assets/img/blog/wheel.jpg" height="200px" width="300px" style="margin-left: 30%" />
                                                </div>

                                                <div>
                                                    <h3>2- Electricity <h3>
                                                            <h6>By Benjamin Franklin in year 1972</h6>
                                                            <p>Benjamin Franklin was condicting his experiments and he accidently discovered electricty
                                                            due to presence of magnetic field. Since then it has led to a great revolution we see around us.</p>

                                                            <img alt="img" src="assets/img/blog/electricity.jpg" height="200px" width="300px" style="margin-left: 30%" />
                                                </div>


                                                <div>
                                                    <h3>3- Computer <h3>
                                                            <h6>By Charles Babbage in early 19th century</h6>
                                                            <p>Chales Babbage who is also known as the father of computer laid the ground for mordern computers.
                                                            Ironically he was a mechanical engineer.</p>

                                                            <img alt="img" src="assets/img/blog/computer.jpg" height="200px" width="300px" style="margin-left: 30%" />
                                                </div>

                                                <div>
                                                    <h3>4- DNA <h3>
                                                            <h6>By Friedrich Miescher in 1869,</h6>
                                                            <p>is a molecule that carries the genetic instructions used in the growth, development,
                                                                functioning and reproduction of all known living organisms and many viruses.</p>

                                                            <img alt="img" src="assets/img/blog/dna.jpeg" height="200px" width="300px" style="margin-left: 30%" />
                                                </div>


                                                <div>
                                                    <h3>5- Finger prints <h3>
                                                            <h6>By William James Herschel</h6>
                                                            <p>Fingerprints are the most convenient method to identification issues.
                                                                It is well known that every human has a different finger print, even though we all do not have different names.
                                                                Fingerprints are what sets us apart from the other billions of people out there,
                                                                and it helps police in working out crime situations to an insane degree.</p>

                                                            <img alt="img" src="assets/img/blog/fingerprint.jpg" height="200px" width="300px" style="margin-left: 30%" />
                                                </div>
